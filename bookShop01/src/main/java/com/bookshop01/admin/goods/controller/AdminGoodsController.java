...
public interface AdminGoodsController {
	...
	public void listOrderGoods(@RequestParam("search_condition") String search_condition,@RequestParam("t_search_word") String t_search_word, HttpServletRequest request, HttpServletResponse response)  throws Exception;
}
