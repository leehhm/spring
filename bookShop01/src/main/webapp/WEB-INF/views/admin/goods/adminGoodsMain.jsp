...
function fn_detail_search(search_condition,t_search_word){
	...
	if(search_condition == "all"){
		location.href = "${contextPath}/admin/goods/selectGoods.do";
	} else {
		location.href = "${contextPath}/admin/goods/listOrderGoods.do";
	}
}
</script>
</head>
   ...
   <form name="frm_goods_list" method="post">   
      <TABLE cellpadding="10" cellspacing="10"  >
         <TBODY>
            ...
            <tr>
              <td>
                <select name="search_condition" id = "search_condition" disabled >
